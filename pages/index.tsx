      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center py-24">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
            Harness the power of AI to discover innovative project ideas tailored for the AI agent era
          </p>
          ...
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg rounded-xl p-6 max-w-sm mx-auto mb-8">
            ...
            <p className="text-4xl font-bold text-blue-600 mb-2">$2<span className="text-lg text-gray-600">/month</span></p>
